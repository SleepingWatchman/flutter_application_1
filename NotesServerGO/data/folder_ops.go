...
func CreateFolder(folder *models.Folder) (int64, error) {
	...
	query := `INSERT INTO Folders (DatabaseId, Name, ParentId, CreatedAt, UpdatedAt)
	          VALUES (:DatabaseId, :Name, :ParentId, :CreatedAt, :UpdatedAt)`
...
func GetFolderByID(id int64, sharedDbID int64) (*models.Folder, error) {
	...
	query := `SELECT Id, DatabaseId, Name, ParentId, CreatedAt, UpdatedAt
...
func UpdateFolder(folder *models.Folder) error {
	...
	query := `UPDATE Folders SET Name = :Name, ParentId = :ParentId, UpdatedAt = :UpdatedAt
...
func GetFoldersForDatabase(databaseID int64) ([]models.Folder, error) {
	...
	finalQuery := `SELECT Id, Name, ParentId, CreatedAt, UpdatedAt, DatabaseId, OwnerUserId 
	               FROM Folders 
	               WHERE DatabaseId = ? 
	               ORDER BY Name ASC`
