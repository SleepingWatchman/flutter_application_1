...
func GetMainSchema() string {
	...
	orderedSchema := SharedDatabasesTable() + FoldersTable() + NotesTable() + ScheduleEntriesTable() + PinboardNotesTable() + ConnectionsTable() + NoteImagesTable() + SharedDatabaseUsersTable()
